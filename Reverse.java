echo "# reverse-a-string" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/Molly-12/reverse-a-string.git
...
class Solution{
    ...
    public static void main(String[] args){     //main function
        ...
        System.out.println(rev(s));  //calling the recursive function and printing the output
